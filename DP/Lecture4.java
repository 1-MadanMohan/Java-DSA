...
public class Lecture4 {
        ...
        static int solveUtil2(int n, int[] height, int[] dp, int k) {
            dp[0] = 0;
    ...
    public static void main(String args[]) {
            ...
            System.out.println(solve2(n, height, k)); // Print the result of the solve function
        }
    }
